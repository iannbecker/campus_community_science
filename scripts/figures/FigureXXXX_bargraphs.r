...
output_dir <- "~/Desktop/project_code/campus_community_science/figures_tables"

# ============================================================================
# CALCULATE SUMMARY STATISTICS FOR PLOTTING (FROM PREVIOUS SCRIPT)
# ============================================================================
...
ggsave(path = output_dir, "unique_visitors_comparison.png", p1, width = 8, height = 6, dpi = 300)
ggsave(path = output_dir, "checklist_count_comparison.png", p2, width = 8, height = 6, dpi = 300)
...
ggsave(path = output_dir, "legend_only.png", legend, width = 6, height = 2, dpi = 300, bg = "white")

# Save summary table for figure

write.csv(combined_summary, "figure_XXXX_combined_summary_stats.csv", row.names = FALSE)
